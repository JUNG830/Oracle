...
--    
INSERT INTO ORDER_INFO (MEMBER_PHONE, ORDER_DATE, ORDER_NO, MNO) 
    VALUES ('01023769756', SYSDATE, SEQ_ORDER_NO.NEXTVAL, '1002');
    
INSERT INTO ORDER_INFO (MEMBER_PHONE, ORDER_DATE, ORDER_NO, MNO)
    VALUES ('01023769756', SYSDATE, SEQ_ORDER_NO.NEXTVAL, '1003');

INSERT INTO ORDER_INFO (MEMBER_PHONE, ORDER_DATE, ORDER_NO, MNO)
    VALUES ('01035742367', SYSDATE, SEQ_ORDER_NO.NEXTVAL, '1004');
    
INSERT INTO ORDER_INFO (MEMBER_PHONE, ORDER_DATE, ORDER_NO, MNO) -- 비회원일 경우 앞에 'N' 붙여줌
