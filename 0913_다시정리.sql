...
/* 회원 정보 입력 */
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01044432345');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01045663456');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01012345674');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01052344578');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01023769756');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01034526785');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01011353467');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01035742367');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01035673457');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01078885678');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01033337788');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01056789804');
INSERT INTO MEMBER_INFO VALUES(TO_CHAR(SEQ_MEMBER_ID.NEXTVAL), '01093742345');
...
INSERT INTO MENU_INFO VALUES (1001, '에스프레소', 2500);
INSERT INTO MENU_INFO VALUES (1002, '아메리카노', 4000);
INSERT INTO MENU_INFO VALUES (1003, '라떼', 5000);
INSERT INTO MENU_INFO VALUES (1004, '카페모카', 5500);
INSERT INTO MENU_INFO VALUES (2001, '초코우유', 2500);
INSERT INTO MENU_INFO VALUES (2002, '녹차', 2500);
INSERT INTO MENU_INFO VALUES (2003, '홍차', 2500);
INSERT INTO MENU_INFO VALUES (2004, '밀크티', 2500);
...
CREATE TABLE ORDER_DETAIL (
    ORDER_NO NUMBER REFERENCES ORDER_INFO(ORDER_NO),  
    OPTION_CODE VARCHAR(20), -- 1 : 사이즈업, 2 : 샷추가, 3 : 시럽추가
    OPTION_COUNT NUMBER
);

/* 주문번호 */
CREATE SEQUENCE SEQ_ORDER_NO2
START WITH 1 -- 몇번부터 시작할래
INCREMENT BY 1  -- 몇씩 증가시킬 것인가.
NOCYCLE -- 반복하지 않음
NOCACHE;

DROP SEQUENCE SEQ_ORDER_NO2;
    
INSERT INTO ORDER_DETAIL(ORDER_NO, OPTION_CODE, OPTION_COUNT) 
    VALUES (SEQ_ORDER_NO2.NEXTVAL, '002', 1);
INSERT INTO ORDER_DETAIL(ORDER_NO, OPTION_CODE, OPTION_COUNT) 
    VALUES (SEQ_ORDER_NO2.NEXTVAL, '003', 1);
INSERT INTO ORDER_DETAIL(ORDER_NO, OPTION_CODE, OPTION_COUNT) 
    VALUES (SEQ_ORDER_NO2.NEXTVAL, '001', 1);
INSERT INTO ORDER_DETAIL(ORDER_NO, OPTION_CODE, OPTION_COUNT) 
    VALUES (SEQ_ORDER_NO2.NEXTVAL, '002', 1);
INSERT INTO ORDER_DETAIL(ORDER_NO, OPTION_CODE, OPTION_COUNT) 
    VALUES (SEQ_ORDER_NO2.NEXTVAL, '001', 1);
...
------------------------------------------
/* JAVA 연동 수정 */
INSERT INTO ORDER_INFO (ORDER_DATE, ORDER_NO, MNO, OPTION_CODE, OPTION_COUNT) 
    VALUES (SYSDATE, SEQ_ORDER_NO.NEXTVAL, '1002', '002', 1);
...
CREATE TABLE CANCEL_MENU (
    ...
    CANCEL_YN VARCHAR2(1) CHECK (CANCEL_YN = 'Y' OR CANCEL_YN = 'N') UNIQUE
); 

INSERT INTO CANCEL_MENU VALUES ('5001', 'Y');
...
DELETE FROM ORDER_INFO OI
    WHERE(OI.MEMBER_ID) = ( SELECT CM.MEMBER_ID
                               FROM CANCEL_MENU CM
                                WHERE CM.CANCEL_YN = 'Y' );
